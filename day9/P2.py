...
#Program runs line by line, executing instruction in sequence
# PYthonn does not execute src code line-by-line directly
# Instead compile it into an intermediate format called Bytecode, which is then run by virtual machine,
...
#Parsing:Tokens are structured into a hierrachical  tree called
...
# GIL: Global Interpretor Lock: only one thread executes bytecode at a time
#  